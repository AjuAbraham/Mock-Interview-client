...
const Room = () => {
  ...
  return (
   <>
    <div className={`${check === "black" && "dark"}`}>
      <div
        className=""
      ...
      >
        ...
        <div className="bg-slate-400 dark:bg-slate-800 h-10 sm:p-6 w-full flex justify-between items-center">
      ...
      <div className={`${check === "black" && "dark"}`}>
        <div className="sm:flex p-1 gap-1 w-full dark:bg-teal-600 bg-zinc-500 ">
          <div className="relative z-1 sm:w-[1100px] w-full dark:bg-slate-600 bg-red-100 sm:h-[calc(100vh-60px)]  h-[400px]">
            <div className="sm:h-12 h-10 flex items-center p-2 justify-between">
              ...
              <button
                className=" dark:bg-green-400 bg-green-300 sm:px-4 sm:py-2 px-1 py-1 border-2 border-black rounded-md items-center cursor-pointer hover:bg-green-600 "
          ...
          <div className="dark:bg-neutral-600 bg-zinc-400 text-center text-xl font-semibold mt-11 sm:mt-0 text-white sm:w-[430px] sm:h-[calc(100vh-60px)] h-[140px]">
            video calling
          </div>
        </div>
      </div>
